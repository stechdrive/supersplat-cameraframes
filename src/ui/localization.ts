...
// Keep the product panels on the same localization service as upstream UI.
const localize = (key: string, options?: LocalizeOptions) => i18n.t(key, options);
const formatInteger = (value: number) => i18n.formatInteger(value);
const getLocale = () => i18n.locale;

export { i18n, localize, formatInteger, getLocale };
