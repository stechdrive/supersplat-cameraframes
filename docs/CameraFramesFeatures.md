...
CAMERA FRAMES v2.21.11 は、A4相当の基準紙に複数のフレームをレイアウトし、アンカー付きの off-axis フラスタムで構図を保ちながらプレビューと書き出しを一致させるための機能群です。プレビューのズームアウトやフレーム操作、カメラポーズ編集、PSD/PNG エクスポートを一体で提供します。
...
- ラベルに `| CAMERA FRAMES v2.21.11` を併記。
